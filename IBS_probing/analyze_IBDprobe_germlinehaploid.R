...
#1.9 cM region
dat1 <- read.table("ibd_rp_chr19.lb45136023.ub45817621.germlinehaploid.match", as.is = TRUE) 
...
#5.9 cM region
dat3 <- read.table("ibd_rp_chr19.lb43834377.ub47047801.germlinehaploid.match", as.is = TRUE) 
...
pdf("probe_germlinehaploid.pdf", width = 5, height = 3)
