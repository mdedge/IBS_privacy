...
#save.image("figures/ibd_rangelists_872.RData")
#load("figures/ibd_rangelists_872.RData")
...
tiff("figures/median_cover_by_n_and_cM_lod1.tif", width = 9, height = 6, units = "in", res = 600, compression = "lzw")
...
medians.plot(apply(allchr.IBD2.covered, c(2,3), median), bait.ns, cM.cuts, pal, ylab = "Median IBS2 coverage (Gbp)", ylim = c(0, 1.6e9), yaxt = "n", xaxt = "n")
axis(2, at = c(0, 5e8, 1e9, 1.5e9), labels = c("0", ".5", "1", "1.5"), las = 1)
axis(1, at = c(100, 300, 500, 700, 872), las = 1)
medians.plot(apply(allchr.IBD1.covered, c(2,3), median), bait.ns, cM.cuts, pal, ylab = "Median IBS1 coverage (Gbp)", ylim = c(0, 1.6e9), yaxt = "n", xaxt = "n")
axis(2, at = c(0, 5e8, 1e9, 1.5e9), labels = c("0", ".5", "1", "1.5"), las = 1)
axis(1, at = c(100, 300, 500, 700, 872), las = 1)
medians.plot(apply(allchr.IBD1.covered + allchr.IBD2.covered, c(2,3), median), bait.ns, cM.cuts, pal, ylab = "Median IBS1+ coverage (Gbp)", ylim = c(0, 1.6e9), yaxt = "n", xaxt = "n")
axis(2, at = c(0, 5e8, 1e9, 1.5e9), labels = c("0", ".5", "1", "1.5"), las = 1)
axis(1, at = c(100, 300, 500, 700, 872), las = 1)
dev.off()

pdf("figures/median_cover_by_n_and_cM_lod1.pdf", width = 9, height = 6)
...
axis(1, at = c(100, 300, 500, 700, 872), las = 1)
medians.plot(apply(allchr.IBD2.covered, c(2,3), median), bait.ns, cM.cuts, pal, ylab = "Median IBS2 coverage (Gbp)", ylim = c(0, 2.8e9), yaxt = "n", xaxt = "n")
axis(2, at = c(0, 5e8, 1e9, 1.5e9, 2e9, 2.5e9), labels = c("0", ".5", "1", "1.5", "2", "2.5"), las = 1)
axis(1, at = c(100, 300, 500, 700, 872), las = 1)
medians.plot(apply(allchr.IBD1.covered, c(2,3), median), bait.ns, cM.cuts, pal, ylab = "Median IBS1 coverage (Gbp)", ylim = c(0, 2.8e9), yaxt = "n", xaxt = "n")
axis(2, at = c(0, 5e8, 1e9, 1.5e9, 2e9, 2.5e9), labels = c("0", ".5", "1", "1.5", "2", "2.5"), las = 1)
axis(1, at = c(100, 300, 500, 700, 872), las = 1)
medians.plot(apply(allchr.IBD1.covered + allchr.IBD2.covered, c(2,3), median), bait.ns, cM.cuts, pal, ylab = "Median IBS1+ coverage (Gbp)", ylim = c(0, 2.8e9), yaxt = "n", xaxt = "n")
axis(2, at = c(0, 5e8, 1e9, 1.5e9, 2e9, 2.5e9), labels = c("0", ".5", "1", "1.5", "2", "2.5"), las = 1)
axis(1, at = c(100, 300, 500, 700, 872), las = 1)
dev.off()
