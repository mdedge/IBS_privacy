...
for(j in chrs){
	IBS<-read.table(paste("ibd_germline_gextend/ibd_chr", as.character(j), "_gextend.match", sep = ""),as.is=TRUE)
...
#save.image("figures/ibd_rangelists_872_germlinegextend.RData")
#load("figures/ibd_rangelists_872_germlinegextend.RData")
...
tiff("figures/median_cover_by_n_and_cM_germlinegextend.tif", width = 7.5, height = 5, units = "in", res = 600, compression = "lzw")
...
pdf("figures/median_cover_by_n_and_cM_germlinegextend.pdf", width = 7.5, height = 5)
